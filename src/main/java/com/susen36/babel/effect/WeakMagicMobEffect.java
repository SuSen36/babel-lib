...
public class WeakMagicMobEffect extends MobEffect {
    ...
    public static void apply(LivingEntity entity, int level, int durationTicks) {
        ...
        MobEffectInstance effect = entity.getEffect(BabelMobEffects.WEAK_MAGIC);
        int amplifier = effect == null ? 0 : effect.getAmplifier() + level;
        entity.addEffect(new MobEffectInstance(BabelMobEffects.WEAK_MAGIC, durationTicks, amplifier, false, true, true));
    }
